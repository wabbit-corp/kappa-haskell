...
| **§28.2** | `Iterator.next` member omitted (only `Item : Type` surfaces) because an associated-type member name can't be resolved in applied-type position — see §14.3.4. | `Prelude.hs:896-913` | medium |
