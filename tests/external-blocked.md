...
| 4 | `BorrowView`/`captureBorrow` projection borrows, zipper/projector-descriptor quantities, resumption-capture QTT (`borrow_qtt.*` 8, residual `effects.*` 5) | §12.4.3, §12.2, §18.1, §19.5 | 13 |
