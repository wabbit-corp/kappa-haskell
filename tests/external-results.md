...
FAIL types.literals.negative_literal_in_nested_result_positions (expected 3 errors, got 5; first error: E_TYPE_EQUALITY_MISMATCH "type mismatch" at line 18; error codes are [E_TYPE_EQUALITY_MISMATCH, E_TYPE_EQUALITY_MISMATCH, E_UNSOLVED_IMPLICIT, E_TYPE_EQUALITY_MISMATCH, E_TYPE_EQUALITY_MISMATCH], expected [E_TYPE_MISMATCH, E_TYPE_MISMATCH, E_TYPE_MISMATCH])
